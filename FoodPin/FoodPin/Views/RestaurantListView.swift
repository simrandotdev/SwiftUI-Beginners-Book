...
struct RestaurantListView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        BasicTextImageView(restaurant: .constant(.init(name: "Name", type: "Type", location: "Location", phone: "222-222-2222", description: "Some long format description here for the restaurant", image: "royaload", isFavorite: false)))
            .previewLayout(.sizeThatFits)
            .previewDisplayName("BasicTextImageRow")
        
        FullImageRow(restaurant: .constant(.init(name: "Name", type: "Type", location: "Location", phone: "222-222-2222", description: "Some long format description here for the restaurant", image: "royaload", isFavorite: false)))
            .previewLayout(.sizeThatFits)

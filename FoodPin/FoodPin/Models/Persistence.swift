...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        do {
            ...
            // fatalError() causes the application to generate a crash log andterminate. You should not use this function in a shipping application, although it may be useful during development.
    ...
    static var testData: [Restaurant]? = {
        ...
        return try? PersistenceController.preview.container.viewContext.fetch(
            fetchRequest) as? [Restaurant]
    }()
}
